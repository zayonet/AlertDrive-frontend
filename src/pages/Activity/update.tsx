        ...
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
            {userActivity?.map((userActivity, index) => {
                <Formik
                    ...
                    initialValues={{
                        user_id: user?.id,
                        whitch_food_ate: userActivity?.whitch_food_ate,
                        whitch_food_drank: userActivity?.whitch_food_drank,
                        smoked: userActivity?.smoked,
                    ...
                    onSubmit={(values) => {
                        ...
                        if (
                            ...
                            updateUserActivity(values, userActivity?.id)
                        }
                ...
                >
                    ...
                    (<ativity.StyledFormArea>
                        <Text style={styles.pickerLabelStyle}>
                            Which food did you eat now? {route.params.itemId}
                        </Text>
